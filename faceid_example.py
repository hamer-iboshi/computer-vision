...
for image_path in image_paths:
    ...
    for (x, y, w, h) in faces:
#        nbr_predicted1, conf1 = recognizer1.predict(predict_image[y: y + h, x: x + w])
        nbr_predicted2, conf2 = recognizer2.predict(predict_image[y: y + h, x: x + w])
        nbr_predicted3, conf3 = recognizer3.predict(predict_image[y: y + h, x: x + w])
